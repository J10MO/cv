...
const ProfessionalCV = () => {
  ...
  const projects = [
    {
      name: "Auraiq - Modern Web Platform",
      description: "Contemporary web platform featuring modern design, responsive layout, and optimized user experience",
      technologies: "React, Next.js, Tailwind CSS, Node.js, MongoDB",
      link: "auraiq.site"
    },
    {
      name: "Dynamic Form Builder",
      description: "Interactive form creation tool with drag-and-drop functionality and real-time preview",
      technologies: "React, TypeScript, Tailwind CSS, Vercel",
      link: "form-builder-6bxd.vercel.app"
    },
    {
      name: "Panta Security System",
      description: "Enterprise security management platform with real-time monitoring and access control",
